...
現行の共通ハーネスは `workflow / phase / core` の責務分担を採っており、repo-level knowledge の置き場もそれに合わせて明確にしておきたい。
...
- `docs/knowledge/classification-driven-workflow-surface.md` を、`workflow / phase / core` の責務分担の参照基準として扱う
