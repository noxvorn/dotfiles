...
- `docs/knowledge/`: repo-level の通常知見を置く
  - [classification-driven-workflow-surface.md](./knowledge/classification-driven-workflow-surface.md): workflow / phase / core の責務分担と要求分類の基準
...
- `dot_codex/skills/`: `core-*` の主役手順と `phase-*` の束ねを置く
