...
- `docs/knowledge/`: repo-level の通常知見を置く
  - [classification-driven-workflow-surface.md](./knowledge/classification-driven-workflow-surface.md): `core-*` 正式入口と deprecated wrapper の扱い
...
- `dot_codex/skills/`: `core-*` の主役手順と、互換用の `entry-*` / `phase-*` wrapper を置く
