...
- `dot_codex/AGENTS.md` と `docs/notes/classification-driven-workflow-surface.md` の両方に代表導線の列挙があり、どちらが正本か迷いやすかった。
...
- `docs/notes/harness-regression-checks.md` に surface の正本説明が混ざっていた。
