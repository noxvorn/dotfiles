---
name: doc-followup
description: 変更後に README、ADR、notes、CONTEXT、skill references などの docs 追従更新を行う時に使う。rename/delete 後の古い path や導線を直し、Codex/Claude surface の片側漏れを確認する。新しい本文や artifact を作る時は `scribe`、確認だけなら `inspect`。
---

# Doc Follow-up

変更後に、関連 docs / index / reference の追従漏れを見つけて最小更新する。
